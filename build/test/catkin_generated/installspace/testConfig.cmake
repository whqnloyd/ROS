...
if("FALSE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/husarion/ROS/src/test)
  set(test_DEVEL_PREFIX /home/husarion/ROS/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/husarion/ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/husarion/ROS/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/husarion/ROS/install/lib;/home/husarion/ROS/devel/lib;/home/husarion/ros-workspace/devel/lib;/opt/ros/kinetic/lib)
